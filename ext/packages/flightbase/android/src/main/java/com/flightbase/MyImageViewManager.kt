...
abstract class BaseImageViewManager(var mCallerContext: ReactApplicationContext) : MyImageViewManagerSpec<MyImageView>() {
    ...
    @ReactProp(name = "src")
    override fun setSrc(view: MyImageView, sources: ReadableArray?) {
    ...
    override fun setResizeMode(view: MyImageView, resizeMode: String?) {
